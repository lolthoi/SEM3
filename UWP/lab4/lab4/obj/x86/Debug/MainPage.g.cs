#pragma checksum "F:\SEM3\UWP\lab4\lab4\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "62D79170269368EB0B5C4A89FF4E6A75"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace lab4
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lab4.Models.Contact dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::lab4.Models.Contact) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lab4.Models.Contact)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::lab4.Models.Contact obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj13_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lab4.Models.Icon dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::lab4.Models.Icon) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lab4.Models.Icon)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::lab4.Models.Icon obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lab4.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lab4.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::lab4.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Contacts(global::System.Collections.ObjectModel.ObservableCollection<global::lab4.Models.Contact> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Icons(global::System.Collections.Generic.List<global::lab4.Models.Icon> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
