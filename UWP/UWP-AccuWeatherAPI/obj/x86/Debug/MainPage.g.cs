#pragma checksum "F:\SEM3\UWP\UWP-AccuWeatherAPI\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "F5A869324E03F2A43AE9664F22FAB660"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace UWP_AccuWeatherAPI
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWP_AccuWeatherAPI.Models.DailyForecast dataRoot;
            ...
            {
                if (lineNumber == 114 && columnNumber == 36)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::UWP_AccuWeatherAPI.Models.DailyForecast) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWP_AccuWeatherAPI.Models.DailyForecast)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::UWP_AccuWeatherAPI.Models.DailyForecast obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Day(global::UWP_AccuWeatherAPI.Models.Day obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::UWP_AccuWeatherAPI.Models.Temperature1 obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Maximum(global::UWP_AccuWeatherAPI.Models.Maximum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Maximum_Value(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Temperature_Minimum(global::UWP_AccuWeatherAPI.Models.Minimum obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature_Minimum_Value(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj11_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWP_AccuWeatherAPI.Models.WeatherJSON dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::UWP_AccuWeatherAPI.Models.WeatherJSON) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWP_AccuWeatherAPI.Models.WeatherJSON)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::UWP_AccuWeatherAPI.Models.WeatherJSON obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Temperature(global::UWP_AccuWeatherAPI.Models.Temperature obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::UWP_AccuWeatherAPI.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 105 && columnNumber == 19)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::UWP_AccuWeatherAPI.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::UWP_AccuWeatherAPI.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_WeatherEachDays(global::System.Collections.ObjectModel.ObservableCollection<global::UWP_AccuWeatherAPI.Models.DailyForecast> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_WeatherEachHours(global::System.Collections.ObjectModel.ObservableCollection<global::UWP_AccuWeatherAPI.Models.WeatherJSON> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 15: // MainPage.xaml line 24
                {
                    this.WeatherLocationTextBlock = (global::Windows.UI.Xaml.Controls.TextBlock)(target);
                }
                break;
